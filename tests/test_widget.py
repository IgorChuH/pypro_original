...
@pytest.mark.parametrize("account_card, expected_result", [("Visa Platinum 7000792289606361", "Visa Platinum 7000 79** **** 6361"), ("Счет 73654108430135874305", "Счет **4305"), ("MasterCard 7000792289606361", "MasterCard 7000 79** **** 6361"), ("Visa Gold 5999414228426353", "Visa Gold 5999 41** **** 6353")])
