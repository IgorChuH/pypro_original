...
class TestBankTransactions(unittest.TestCase):
    ...
    def test_sort_by_date(self):
        ...
        self.assertEqual(sorted_data[0]['date'], "2018-02-03T07:16:28.366141")  # Открытие вклада
        self.assertEqual(sorted_data[1]['date'], "2018-07-22T07:42:32.953324")  # Перевод организации
        self.assertEqual(sorted_data[2]['date'], "2018-08-17T03:57:28.607101")  # Перевод организации (Canceled)
